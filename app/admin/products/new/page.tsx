...
export default function NewProductPage() {
  ...
  const [lengths, setLengths] = useState<{ length: string }[]>([]);
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Add the available colors for this product.</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Add the available lengths for this product.</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-end gap-2">
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button type="submit" disabled={isSubmitting}>
              {isSubmitting ? <LoadingSpinner size="small" /> : "Create Product"}
            </Button>
          </div>
        </form>
      </Form>
